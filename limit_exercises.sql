...
-- Limit says how many results per page, OFFSET skips results so can skip the pages we've already used, page number will list however many results the limit gives us and OFFSET will tell the page number how many results to skip in order to provide the correct results